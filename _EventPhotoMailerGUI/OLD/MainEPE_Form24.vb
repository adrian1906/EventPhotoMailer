...
Public Class Form1
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        ' This program checks to see if code and .dll file matches. It needs to be the 1st function
        ' called before the others. It is only supposed to be called once or an error will occur. 
    ...
    Private Sub GoButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles GoButton.Click
        ...
        If Code < 0 Then
            ...
            'Note: Cannot issue a seeClose(0) & seeRelease() immediately after a failed seeSmtpConnect. Therefore
            'another seeXXXX() is issued.
            'Display("Emailing has been aborted. Please check your mailserver parameters")
            'Code = seeIntegerParam(0, SEE_ENABLE_IMAGE, 1)
            Code = seeSmtpConnect(0, "hoodands.ipower.com", UserCompanyName, NullString)
            MsgBox("seeClose() is about to close ")
            Code = seeClose(0)
            MsgBox("seeClose is closed")
            Exit Sub
        End If
