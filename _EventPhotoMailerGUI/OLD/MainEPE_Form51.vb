...
Public Class Form1
    ...
    Public Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        MyForm2.Hide()
        Me.Name = " Event Photo Emailer - Version: " & My.Application.Info.Version.ToString
...
#Region "MainProgram"
    ...
    Public Sub AccessControlStatusbox()
...
#End Region
    ...
    Public Sub SENDEMAIL(ByVal email As String, ByVal filenamestring As String, ByVal EventFolder As String, ByVal filenameshort As String, ByRef GOFLAGG As String, ByRef SENDEMAILFLAGG As Boolean)
        ...
        If CancelFlagg <> "Cancel" Then
            ...
            If SendEmailCode < 0 Then 'Code corresponding to seeSendEmail()
                ...
                Display("Also, check if your security software allows outgoing mail on port: " & MyForm2.PortBox.Text)
                Display("") ' ads a CR+LF
                CancelFlagg = "Cancel"
                'End If
            Else
    ...
    Public Sub Display(ByVal X As String)
    ...
    Public Sub PictureBox1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        FolderBrowserDialog_image_location.ShowDialog()
    ...
    Public Sub CheckBox2_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Public Sub Button_SaveAsDefault_Click(ByVal sender As Object, ByVal e As EventArgs) Handles Button_SaveAsDefault.Click
        Dim DefaultFile As String = ProgDir2.Text & "\bin\defaults.txt"
    ...
    'public sub Button5_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button_SaveAsDefault.Click
    '    Dim DefaultFile As String = ProgDir2.Text & "\bin\defaults.txt"
    ...
    Public Sub ExitEPEForm() Handles ExitEPE.Click
...
exit_function:
    ...
    Public Sub SMTPdots_timer(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CheckSMTPtimerdots.Tick
        'MsgBox("OK Now What")
