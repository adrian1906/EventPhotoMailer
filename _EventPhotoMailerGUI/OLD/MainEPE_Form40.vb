...
Public Class Form1
    ...
    Public Sub LetsGO()
        ...
        If CancelFlagg <> "Cancel" Then
            ...
            While chkSMTP.SMTPOK = False Or timecheck < maxduration ' Timeout set to 10 seconds.
                mydate2 = Now
    ...
    Public Sub SendParsedEmails()
       ...
       " was not sent" & " Counter = " & counter)
        ...
        If MonitorFolderCheckBox.CheckState = CheckState.Checked Then
            ...
            'StoppedButton.Visible = True
            'StoppedButton.BackColor = Color.Aqua
            'Else
    ...
    Private Sub checkinternetconnection()
        If My.Computer.Network.Ping("www.google.com") Then ' this is preferred since it checks internet connectin
            'If My.Computer.Network.IsAvailable Then ' This method checks network connection, not quite internet
            ConnectionStatusResultLabel.Text = "Connected"
        Else
            ConnectionStatusResultLabel.Text = "Not Connected"
        End If
    End Sub
