...
Public Class Form1
    ...
    Dim CompanyEmail As String = "<kirksphotos1@mac.com>" ' Photofellas
    Dim UserCompanyName As String = "Kirk Queen Photography" & " " & CompanyEmail
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim MyPROGRAM As New Process()
        MyPROGRAM.StartInfo.FileName = CurrentDirectory & "\DarkroomShortcut_CNTRL_Z.exe"
        'MyPROGRAM.StartInfo.Arguments = " "
        MyPROGRAM.Start()
    ...
    Private Sub SENDEMAIL(ByVal email As String, ByVal filenamestring As String, ByVal EventFolder As String, ByVal filenameshort As String, ByRef GOFLAGG As String, ByRef SENDEMAILFLAGG As Boolean)
        ...
        If CancelFlagg <> "Cancel" Then
            ...
            ' Display("Entered Wait Loop")
            ' Code = seeIntegerParam(0, SEE_CONNECT_WAIT, 20000) ' maximum time allowed to complete a connection to the email server.
            'Dim CodeSMTPCHECK = seeIntegerParam(0, SEE_MIN_RESPONSE_WAIT, 1000) 'time after which a "timeout" error occurs if the server has not responded.
