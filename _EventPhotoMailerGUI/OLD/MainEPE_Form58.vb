...
#End Region
    ...
    ''' <remarks>This code is called ONLY at initialization by pressing the FACEBOOK button. All uploads to Facebook is 
    ''' done using AdrianHood
    ''' This code requires my EPE Facebook appliation ID: "197403413634224" </remarks>
    Public Function GetAPIandAlbumID(ByRef CHECKTIMEROK As Boolean, ByVal MyWebBrowser As WebBrowser) As HoodFacebookInfo
        ...
        Dim MyAPI As Facebook_Graph_Toolkit.GraphApi.Api = New Api(MAT)
        ' **************  Get list of albums ********
    ...
    Public Sub FBauth_click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PictureBox1.Click
        Dim AccessToken As String = FBAuthenticate()
    End Sub
    ...
    Public Function FBAuthenticate() As String
        ...
        Do While BrowserReadyFlagg = False And BrowserCounter < 20
            AccessURI = WebBrowser1.Url.ToString
            ...
            End If
        Loop
        If BrowserCounter = 20 Then
            MsgBox("Facebook authorization was not successful")
        End If
        checktimerOK = False
        Dim MyURI() As String
        ...
        WebWait(MyFacebookForm.WebBrowser1, 15)
