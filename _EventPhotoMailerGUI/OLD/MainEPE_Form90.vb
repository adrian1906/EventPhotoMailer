...
Imports Facebook_Graph_Toolkit.GraphApi.Application
...
Public Class Form1
    ...
    End Structure
    Structure HoodUserInfo
        Dim MyURI() As String
        Dim MyAccessToken As String
        Dim MyAPI As Api
        Dim MyID As String  ' Not sure of this one..gonna try UserID and AppID
    End Structure
    ...
    Public MAT As HoodUserInfo = Nothing
    ...
    Public Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        'End If
        'Dim testimage As String = "C:\EventPhotoEmailer\EPE_Hotfolder\Day1\$img0028_01.jpg"
        'Dim testerstring As String = EmailPrompt(testimage)
        'MsgBox(testerstring)
    End Sub
...
#Region "MainProgram"
    ...
    Public Sub RunGo()
        ...
        End If
        If ChkInt = "1" Or CheckForIntConnectYesNo = False Then
...
#End Region
    ...
    Public Function GetAPIandAlbumID(ByRef CHECKTIMEROK As Boolean, ByVal MyWebBrowser As WebBrowser) As HoodFacebookInfo
        ...
        'If INTCHECK = "1" Then
        If IsNothing(MyAPI) Then
            Me.MAT = FBAuthenticate2()
            'Dim MAT As String = FBAuthenticate()
            MyAPI = New Api(MAT.MyAccessToken)
            FacebookAuth_indicatorLabel.Text = "Authenticated"
        End If

        ' **************  Get list of albums *******
        Dim MyAlbums As System.Collections.Generic.IList(Of Facebook_Graph_Toolkit.GraphApi.Album) = GraphApi.User.GetAlbums(MAT.MyID, MAT.MyAccessToken, 0, 100)
        ...
        If Myaid = Nothing Then ' Album does not exist .... need to make it
            ...
            If albumok = True Then 'check albums again and get id of match
                ...
                Do While counter5 < 5 And albumfoundflagg = False
                    ...
                    counter5 = counter5 + 1
                    MyAlbums = GraphApi.User.GetAlbums(MAT.MyID, MAT.MyAccessToken, 0, 100)
    ...
    Public Sub GetAlbumsAndPopulateDropdown(ByVal MyWebBrowser As WebBrowser)
        If IsNothing(MyAPI) Then
            Dim MAT As String = FBAuthenticate()
            MyAPI = New Api(MAT)
            FacebookAuth_indicatorLabel.Text = "Authenticated"
    ...
    Public Function FBAuthenticate2() As HoodUserInfo
        ' GraphApi.Api()
        ' Adrian ID:            https://graph.facebook.com/601201034
        ' Hood and Sons ID:     https://graph.facebook.com/152049444821811
        ' fanpage ID (page_ID)  152049444821811
        ...
        Dim BrowserReadyFlagg As Boolean = False
        Dim AccessURI As String = Nothing
        Dim MyURI() As String = Nothing
        Dim BrowserCounter As Integer = 0
        Dim MaxLoginTime As Integer = 120
        FacebookGUI.LoginCountDownLabel.Text = MaxLoginTime.ToString
        Dim remaining As Integer
        Dim MyAccessToken As String
        Dim MyMAT As HoodUserInfo = Nothing
        Do While BrowserReadyFlagg = False And BrowserCounter < MaxLoginTime And IsForm2Open
            Try
        ...
        Else
            ...
            Else
                ...
                Dim myAPI As New Api(MyAccessToken) 'global
                checktimerOK = True
                MyMAT.MyAccessToken = MyAccessToken
                MyMAT.MyAPI = myAPI
                MyMAT.MyURI = MyURI
                MyMAT.MyID = AppID
            End If
    ...
    Private Sub Label2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles AlbumButton.Click
