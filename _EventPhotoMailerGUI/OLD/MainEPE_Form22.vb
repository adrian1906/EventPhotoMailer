...
Public Class Form1
    ...
    Private Sub GoButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles GoButton.Click
        ...
        If GoFlagg = True Then 'Global variable use to ensure this call to GoButton is only done once.
            ...
            Dim directoryfilenamestring As String = ""
                            ...
                            Else
                                ...
                                If temp.Length > 1 Then
                                    For counter2 = 0 To temp.Length - 1
                                        If ignoreJPG.Checked Then
                                            temp(counter2) = temp(counter2) & ".jpg" ' Case for Cedric of Washington who wants to avoid typing .jpg
                                        End If
                                        directoryfilenamestring = directoryfilenamestring & Textbox_imagefolder.Text & "\" & temp(counter2)
                                        If counter2 < temp.Length - 1 Then
                                            directoryfilenamestring = directoryfilenamestring & ";"
                                        End If
                                    Next
                                Else
                                    directoryfilenamestring = Textbox_imagefolder.Text & "\" & filename
                                End If
                                SENDEMAIL(email, directoryfilenamestring, EventFolder, filename)
                            End If
                        Else
