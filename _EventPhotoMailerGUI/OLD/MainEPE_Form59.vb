...
Public Class Form1
    ...
    Public SiteToPing As String = "www.google.com" ' used to detect internet connection availability
    ...
    Public DefaultFile As String = CurrentDirectory & "\bin\Defaults.txt"
        ...
        If CHECKCONNECTIONYESNO = True Or InitialConnectionCheck = True Then
            Try
                If My.Computer.Network.IsAvailable Then
                    If My.Computer.Network.Ping(SiteToPing) Then ' this is preferred since it checks internet connection
...
#End Region
    ...
    Public Function FBAuthenticate() As String
        ...
        Do While BrowserReadyFlagg = False And BrowserCounter < MaxLoginTime
            Try
    ...
    Public Sub Fill_ISP_Listbox(ByVal MAINpath As String)
        ...
        While Not SS.EndOfStream
            ...
            'tmp2 = "<" & tmp1(0) & "> " & tmp1(1)
            tmp2 = tmp1(0) & " - " & tmp1(1)
            MyForm2.ListBox1.Items.Add(tmp2)
        End While
        SS.Close()
    End Sub
