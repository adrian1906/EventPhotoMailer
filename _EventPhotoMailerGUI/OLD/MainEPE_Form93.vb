...
Public Class Form1
    ...
    Public Sub SaveAsXML(ByVal sender As Object, ByVal e As EventArgs) Handles Button_SaveAsDefault.Click
        ...
        Else
            t = 0
        End If
        MyInfoArraylist.Add("UseMasterListBool" & "!" & t)
        If MyForm2.IncludeAdCheckBox.CheckState = CheckState.Checked Then
            t = 1
        Else
            t = 0
        End If
        MyInfoArraylist.Add("UseAdLabelBool" & "!" & t)
        ...
        Else
            t = 0
        End If
        MyInfoArraylist.Add("ConfimEmailBool" & "!" & t)
        ...
        Else
            t = 0
        End If
        MyInfoArraylist.Add("CombineEmailsBool" & "!" & t)
        ...
        Else
            t = 0
        End If
        MyInfoArraylist.Add("UseSSLBool" & "!" & t)
        ...
        Else
            t = 0
        End If
        MyInfoArraylist.Add("CheckInternetConnectionBool" & "!" & t)
        ...
        Else
            t = 0
        End If
        MyInfoArraylist.Add("PostEmailPromptBool" & "!" & t)
