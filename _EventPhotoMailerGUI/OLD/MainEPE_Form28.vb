...
Public Class Form1
    ...
    Dim NullString As String = Chr(0) ' used with seeVB
    ...
    Private Sub GoButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles GoButton.Click
        ...
        '1/6/2010 It was decided that the cancel flagg be removed from this location. A better position would be at the send email stage 
        'CancelFlagg = "RUN" ' Used to control the running of the emailer
        ...
        If CancelFlagg = "Run" Then 'Global variable use to ensure this call to GoButton is only done once.
