...
Public Class Form1
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If COMPDATA.EvaluationMode = True Then
            MsgBox("You are operating in Evaluation Mode. Your Company Name and Company Email address will reflect this")
        End If
    ...
    Private Sub GoButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles GoButton.Click
        ...
        If CancelFlagg <> "Cancel" Then
            ...
            pause(1000)
            Dim chkSMTP As MAILERRORHOOD = CheckEmailConnection() ' Returns SMTPOK = True if OK
        ...
        Else
            ...
            While d4.Peek() > -1
                ...
                If linecounter <> 0 Then
                    ...
                    ProgressBar1.Value = 100 * Convert.ToInt32(loopcounter / linecounter)
                End If
                loopcounter += 1
            End While
            d4.Close()
    ...
    Public Sub SendParsedEmails()
        ...
        If MonitorFolderCheckBox.CheckState = CheckState.Checked Then
            System.Threading.Thread.Sleep(Convert.ToInt32(DelayTextBox1.Text) * 1000) 'I believe the trigger occurs when file appears but not when finished.
    ...
    Private Function GetLicenseCode(ByVal DIRECTORY As String) As CompanyInfoSTRUCTURE
        ...
        If File.Exists(DefaultFile) Then
            ...
            d.Close()
            Try
                Dim testy = MyDecryption(PassCode)
            Catch ex As Exception
                Dim returnvalue = MsgBox("Invalid Passcode. Please verify the value in your " & _
            DefaultFile & " file is correct. Would you like to continue in Evaluation Mode?", MsgBoxStyle.YesNo)
                If returnvalue = MsgBoxResult.No Then
                    End
                Else
                    COMP.EvaluationMode = True
                End If
            End Try
            If COMP.EvaluationMode = False Then
                tester = Split(MyDecryption(PassCode), "$$$")
                If tester.Length = 1 Then
                    Dim returnvalue = MsgBox("Invalid Passcode. Please verify the value in your " & _
                    DefaultFile & " file is correct. Would you like to continue in Evaluation Mode?", MsgBoxStyle.YesNo)
                    If returnvalue = MsgBoxResult.No Then
                        End
                ...
                End If
            End If
        Else ' lic.dat does not exist
            PassCode = InputBox("Please Enter Your Passcode")
            Dim fs As New FileStream(DefaultFile, FileMode.Create, FileAccess.Write) 'Set to create so old file will be totally rewritten
            Dim s As New StreamWriter(fs)
            'creating a new StreamWriter and passing the filestream object fs as argument
            s.BaseStream.Seek(0, SeekOrigin.End)
            ...
            If tester.Length = 1 Then
                Dim returnvalue = MsgBox("Invalid Passcode. Please verify the value in your" & _
            "\bin\lic.dat file is correct. Would you like to continue in Evaluation Mode?", MsgBoxStyle.YesNo)
                If returnvalue = MsgBoxResult.No Then
    ...
    Private Sub CheckBox1_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CheckBox_ConfirmationEmail.CheckedChanged

    End Sub

    Private Sub ExitEPEForm(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ExitEPE.Click

    End Sub

    Private Sub HideEPEForm(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles HideEPE.Click

    End Sub

    Private Sub ShowEPEForm(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ShowEPE.Click
