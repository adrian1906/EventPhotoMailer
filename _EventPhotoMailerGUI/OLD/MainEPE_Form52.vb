...
Public Class Form1
    ...
    Public Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If File.Exists(DefaultFile) Then
            ...
            Try
                MyForm2.FacebookTextBox.Text = MyDecryption(d.ReadLine())
                If MyForm2.FacebookTextBox.Text = "InvalidPasscode$$$Corrupt" Then
                    MyForm2.FacebookTextBox.Text = "Enter Facebook Address"
                End If
            Catch ex As Exception
                MyForm2.FacebookTextBox.Text = "Enter Facebook Address"
            End Try
    ...
    Public Sub Button_SaveAsDefault_Click(ByVal sender As Object, ByVal e As EventArgs) Handles Button_SaveAsDefault.Click
        ...
        s.WriteLine(MyEncryption(MyForm2.FacebookTextBox.Text))
        If MonitorFolderCheckBox.CheckState = CheckState.Checked Then
            s.WriteLine("1")
        Else
            s.WriteLine("0")
...
#Region "MainProgram"
    ...
    Public Sub SendParsedEmails(ByVal sender As Object, ByVal e As EventArgs) Handles BW_EmailerParcer.DoWork
        ...
        If FacebookCheckBox.CheckState = CheckState.Unchecked Then
...
#End Region
    ...
    Public Sub SENDEMAIL(ByVal email As String, ByVal filenamestring As String, ByVal EventFolder As String, ByVal filenameshort As String, ByRef GOFLAGG As String, ByRef SENDEMAILFLAGG As Boolean)
        ...
        If CancelFlagg <> "Cancel" Then
            ...
            'check Email To
            If FacebookCheckBox.CheckState = CheckState.Checked Then
                emailuse = "<" & MyForm2.FacebookTextBox.Text & ">"
            Else
                emailuse = email
            End If
    ...
    Public Sub Display(ByVal STATUSBOX As TextBox, ByVal X As String)
...
#End Region
    ...
    Public Function checkinternetconnection() As String
        ...
        If CHECKCONNECTIONYESNO = True Then
            Try
...
#End Region
    ...
    Public Sub FacebookCheckBoxChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles FacebookCheckBox.CheckedChanged
        If FacebookCheckBox.CheckState = CheckState.Checked Then
            MyForm2.FacebookTextBox.Visible = True
        Else
            MyForm2.FacebookTextBox.Visible = False
        End If
    End Sub
