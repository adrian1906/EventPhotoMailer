...
Public Class Form1
    ...
    Public MyFacebookBrowser As New FacebookGUI()
...
#End Region
    ...
    ''' <summary>
    ''' GetAPI is used to get the FACEBOOK Token Information
    ''' </summary>
    ''' <param name="email"> Facebook email address</param>
    ''' <param name="password">Facebook password</param>
    ''' <param name="CHECKTIMEROK"></param>
    ''' <param name="MyWebBrowser">Current Webbrowser Object</param>
    ''' <returns>A structured variable based on HoodFacebookInfo which hold the desired info: AccessToken, ID, and App Secret</returns>
    ''' <remarks>This code requires my EPE Facebook appliation ID: "197403413634224" </remarks>
    Public Function GetAPI(ByVal email As String, ByVal password As String, ByRef CHECKTIMEROK As Boolean, ByVal MyWebBrowser As WebBrowser) As HoodFacebookInfo
        ...
        Dim ExtendedPermissions As String = "publish_stream,offline_access,user_photos"
        ...
        Dim AuthorizeUrl As String = String.Format("https://graph.facebook.com/oauth/authorize?client_id={0}&redirect_uri={1}&scope={2}&response_type=token", _
                                                   AppID, WindowLocationString, ExtendedPermissions)
