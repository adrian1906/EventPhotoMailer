...
#End Region
    ...
    Private Sub Testbutton_Click(sender As System.Object, e As System.EventArgs) Handles Testbutton.Click
        Dim filenamestring As String = "C:\EventPhotoEmailer\Email_Filename_Test_Folder\Penguins.jpg"
        Dim InputString As String = filenamestring & " Has been successfully sent!"
