...
Public Class Form1
    ...
    Public Sub ImportDefaults(ByVal DefaultFileToUse As String)
        ...
        MyForm2.CompNameTextbox.Text = COMPDATA.CompanyName
        MyForm2.CompEmailTextbox.Text = COMPDATA.CompanyEmail
...
#End Region
    ...
    ' ''' </summary>
    ' ''' <remarks></remarks>
    ''Public Sub FacebookCheckBoxChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles FacebookOnlyRadio.CheckedChanged, EmailOnlyRadio.CheckedChanged, EmailAndFacebookRadio.CheckedChanged
    ''    If sender.Equals(FacebookOnlyRadio) Then
    ''        If FacebookOnlyRadio.CheckState = CheckState.Checked Then
    ''            EmailOnlyRadio.CheckState = CheckState.Unchecked
    ''            EmailAndFacebookRadio.CheckState = CheckState.Unchecked
    ''            AlbumComboBox.Enabled = True
    ''            GoButton.Text = "Send to Facebook"
    ''        End If
    ''    End If

    ''    If sender.Equals(EmailOnlyRadio) Then
    ''        If EmailOnlyRadio.CheckState = CheckState.Checked Then
    ''            FacebookOnlyRadio.CheckState = CheckState.Unchecked
    ''            EmailAndFacebookRadio.CheckState = CheckState.Unchecked
    ''            GoButton.Text = "Send Email"
    ''        End If
    ''    End If

    ''    If sender.Equals(EmailAndFacebookRadio) Then
    ''        If EmailAndFacebookRadio.CheckState = CheckState.Checked Then
    ''            EmailOnlyRadio.CheckState = CheckState.Unchecked
    ''            FacebookOnlyRadio.CheckState = CheckState.Unchecked
    ...
    ''    If FacebookOnlyRadio.CheckState = CheckState.Unchecked And EmailOnlyRadio.CheckState = CheckState.Unchecked And EmailAndFacebookRadio.CheckState = CheckState.Unchecked Then
    ''        EmailOnlyRadio.CheckState = CheckState.Checked
    ''    End If
    ''End Sub
