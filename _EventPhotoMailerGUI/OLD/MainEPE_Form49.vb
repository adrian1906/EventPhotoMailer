...
Public Class Form1
    ...
    Public Function CheckEmailConnection() As MAILERRORHOOD
        ...
        Code = seePop3Connect(0, textBox_MailServer.Text, textBox_Username.Text, textBox_Password.Text) ' Used to access pop3 (if pop3 before smtp is needed)
        'MsgBox("The Code is : " & Code)
    ...
    Private Sub SENDEMAIL(ByVal email As String, ByVal filenamestring As String, ByVal EventFolder As String, ByVal filenameshort As String, ByRef GOFLAGG As String, ByRef SENDEMAILFLAGG As Boolean)
        ...
        If CancelFlagg <> "Cancel" Then
            ...
            Else
                If BuildType = True Then
                    SendEmailCode = seeSendEmail(0, email, NullString, NullString, textBox_SubjectLine.Text, APPENDEDMESSAGE, filenamestring)
