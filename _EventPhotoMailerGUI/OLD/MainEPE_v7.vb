...
Public Class Form1
    ...
    'Public MyMakeThinForm As New MakeThinForm()
    ...
    Public SavedEmails As New AutoCompleteStringCollection
    Public SavedNames As New AutoCompleteStringCollection
    ...
    Public Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        WinZProgram.StartInfo.FileName = CurrentDirectory & "\EventPhotoEmailer\bin\" & WinZShortcut & ".exe"
        ...
        ToolTip1.SetToolTip(MyEmailSetupForm.EmailCombineCheckBox, "By default, images to the same email address " & vbCrLf & _
                            "are combined into one email. Check this box to send the images individually. ")
        ToolTip1.SetToolTip(MyEmailSetupForm.CheckBox_ConfirmationEmail, "Check this box if you would like an email also" & vbCrLf & _
    ...
    Public Sub ImportDefaults(ByVal DefaultFileToUse As String)
        ...
        If DefaultFileToUse = DefaultFile1 Then
            MyEmailSetupForm.CurrentConfigLabel.Text = "Configuration 1 is being used."
        ElseIf DefaultFileToUse = DefaultFile2 Then
            MyEmailSetupForm.CurrentConfigLabel.Text = "Configuration 2 is being used."
        End If
        ...
        MyEmailSetupForm.CheckBox_ConfirmationEmail.CheckState = BooleanToCheckState(mydata.ConfimEmailBool)
        MyEmailSetupForm.EmailCombineCheckBox.CheckState = BooleanToCheckState(mydata.CombineEmailsBool)
        Try
            With MyEmailSetupForm
                ...
                .PostEmailPrompt_CheckBox1.CheckState = BooleanToCheckState(mydata.PostEmailPromptBool)
    ...
    Public Sub SaveAsXML(ByVal sender As Object, ByVal e As EventArgs) Handles Button_SaveAsDefault.Click
        ...
        MyInfoArraylist.Add("CompanyName" & "!" & MyEmailSetupForm.CompNameTextbox.Text)
        MyInfoArraylist.Add("CompanyEmail" & "!" & MyEmailSetupForm.CompEmailTextbox.Text)
        ...
        MyInfoArraylist.Add("MailServer" & "!" & MyEmailSetupForm.textBox_MailServer.Text)
        MyInfoArraylist.Add("UserName" & "!" & MyEmailSetupForm.textBox_Username.Text)
        MyInfoArraylist.Add("PWDEncrypt" & "!" & MyEncryption(MyEmailSetupForm.textBox_Password.Text))
        MyInfoArraylist.Add("Port" & "!" & MyEmailSetupForm.PortBox.Text)
        MyInfoArraylist.Add("TimeInterval" & "!" & TimeIntervalTextBox.Text)
        MyInfoArraylist.Add("EmailMasterListName" & "!" & MyEmailSetupForm.EmailMasterListFilename.Text)
        MyInfoArraylist.Add("UseMasterListBool" & "!" & CheckStateToBoolean(MyEmailSetupForm.UseMasterListCheckbox.CheckState))

        MyInfoArraylist.Add("ConfimEmailBool" & "!" & CheckStateToBoolean(MyEmailSetupForm.CheckBox_ConfirmationEmail.CheckState))
        MyInfoArraylist.Add("CombineEmailsBool" & "!" & CheckStateToBoolean(MyEmailSetupForm.EmailCombineCheckBox.CheckState))
        MyInfoArraylist.Add("UseSSLBool" & "!" & CheckStateToBoolean(MyEmailSetupForm.SSLcheckBox.CheckState))
        MyInfoArraylist.Add("CheckInternetConnectionBool" & "!" & CheckStateToBoolean(MyEmailSetupForm.Checkbox_CheckForIntConnectYesNo.CheckState))
        MyInfoArraylist.Add("PostEmailPromptBool" & "!" & CheckStateToBoolean(MyEmailSetupForm.PostEmailPrompt_CheckBox1.CheckState))
        MyInfoArraylist.Add("UseAdLabelBool" & "!" & CheckStateToBoolean(MyEmailSetupForm.IncludeAdCheckBox.CheckState))
        MyInfoArraylist.Add("Adfile" & "!" & MyEmailSetupForm.AdLabel2.Text)

        'MyInfoArraylist.Add("PromptForEmailOnly" & "!" & MyEmailSetupForm.PromptForEmailOnly_RadioButton.Checked)
        'MyInfoArraylist.Add("PromptForEmailAndSend" & "!" & MyEmailSetupForm.DontPromptForEmailAndSend_RadioButton.Checked)
        'MyInfoArraylist.Add("DontPromptForEmail" & "!" & MyEmailSetupForm.DontPromptForEmailAndSend_RadioButton.Checked)
...
#Region "MainProgram"
    ...
    Public Sub enabletextboxes(ByVal Decision As Boolean)
        ...
        MyEmailSetupForm.textBox_MailServer.Enabled = Decision
        textBox_messagefile.Enabled = Decision
        MyEmailSetupForm.textBox_Password.Enabled = Decision
        textBox_SubjectLine.Enabled = Decision
        MyEmailSetupForm.textBox_Username.Enabled = Decision
    End Sub
    ...
    Public Sub SendEmail_AND_HandleControlsOnThread(ByVal sender As Object, ByVal e As ProgressChangedEventArgs) Handles BW_LetsGo.ProgressChanged
        ...
        If MyEmailSetupForm.Checkbox_CheckForIntConnectYesNo.Checked Then
            pause(1000)
        End If
        CancelFlagg = "Run"
        ...
        If CancelFlagg <> "Cancel" Then
            ...
            MainStatusBox.Clear()
            If (MyEmailSetupForm.PromptButDelaySendingCheckbox.Checked Or MyEmailSetupForm.Checkbox_CheckForIntConnectYesNo.Checked = False) And _
    ...
    Public Sub GetEmailsFromMasterDirectory()
        ...
        Dim FullPath = MyEmailSetupForm.EmailMasterListFilename.Text
        Dim EmailFileLine As String
        Dim counter As Long = 0
        Dim tmp() As String
        SavedEmails = Nothing ' Clear variable to avoid duplicates. This subroutine is updated after each email
        Try
            objReader = New StreamReader(FullPath)
            While objReader.EndOfStream = False
                    EmailFileLine = objReader.ReadLine()
                    If counter > 0 Then ' Avoid top line
                        tmp = Split(EmailFileLine, ",")
                        If tmp.Length > 1 Then
                            If tmp(2) <> "" Then
                            SavedEmails.Add(tmp(2)) ' Event,Filename,emailaddress
                            If tmp.Length > 2 Then ' If names are saved with email address (will be in 4th column)
                                SavedNames.Add(tmp(3)) 'Event,Filename,emailaddress,Name
                            End If
                            End If
                        End If
                    End If
        ...
        Catch
        End Try
        EmailTable = ConvertEmailFileToTable(MyEmailSetupForm.EmailMasterListFilename.Text) 'not used yet
    End Sub
    ...
    Public Sub SendParsedEmails(ByVal sender As Object, ByVal e As EventArgs) Handles BW_EmailerParcer.DoWork
        ...
        For Each fullstring In listing ' This loops parses the files and produces arrays for email() and filename()
                ...
                Else
                    If temp(0) = "" Then ' case for cancel or blank lines
                        ...
                        If Msboxreply = 1 Then ' OK
                            ...
                            temp(0) = EmailPrompt(newfilename) 'returns EmailString2 ** NameString
            ...
            ContinueOrCancel = Nothing ' reset
            'Separate Names from Email Addresses
            temp2 = Split(temp(0), "**")
            Dim EmailString2 = temp2(0)
            Dim NameString = temp2(1)

            Dim ParseName = Split(NameString, "!")
        ...
        If SendLaterFlagg = False Or MyEmailSetupForm.PromptButDelaySendingCheckbox.Checked Then
...
#End Region
    ...
    Public Sub Combine(ByRef emailarray() As String, ByRef filenamearray() As String, ByRef emailstring() As String, ByRef filenamestring() As String)
        ...
        If MyEmailSetupForm.EmailCombineCheckBox.Checked Then
    ...
    Public Sub SENDEMAIL(ByVal email As String, ByVal filenamestring As String, ByVal EventFolder As String, ByVal filenameshort As String, ByRef GOFLAGG As String, ByRef SENDEMAILFLAGG As Boolean, Optional ByVal EmailName As String = "")
        ...
        If CancelFlagg <> "Cancel" Then
            ...
            If EmailAndFacebookRadio.Checked Or EmailOnlyRadio.Checked Then
                ...
                If Len(MyEmailSetupForm.PortBox.Text) = 0 Then
                    MyEmailSetupForm.PortBox.Text = "25"
                End If

                If Len(MyEmailSetupForm.textBox_MailServer.Text) = 0 Then
                ...
                If Len(MyEmailSetupForm.CompEmailTextbox.Text) = 0 Then
                ...
                If MyEmailSetupForm.IncludeAdCheckBox.Checked And Not MyEmailSetupForm.AdLabel2.Text = "" Then
                    FileStringToUse = filenamestring & ";" & MyEmailSetupForm.AdLabel2.Text
                Else
                ...
                If BuildType = True Then
                    Try
                        SendEmailCode = MailHood(MyEmailSetupForm.CompEmailTextbox.Text, FileStringToUse)
                    Catch ex As Exception
                ...
                If MyEmailSetupForm.CheckBox_ConfirmationEmail.Checked Then
                    Try
                        SendEmailCode = MailHood(MyEmailSetupForm.CompEmailTextbox.Text, FileStringToUse)
                    Catch ex As Exception
                        SendEmailCode = MailHood(MyEmailSetupForm.CompEmailTextbox.Text, filenamestring)
                    End Try
                End If
                ...
                If SendEmailCode.SMTPOK = False Then 'Code corresponding to MailHood
                    ...
                    Display(MainStatusBox, "Also, check if your security software allows outgoing mail on port: " & MyEmailSetupForm.PortBox.Text)
                ...
                'If Not IsNothing(MyEmailSetupForm.EmailMasterListFilename.Text) Then
                If MyEmailSetupForm.UseMasterListCheckbox.Checked Then
                    Try
                        My.Computer.FileSystem.WriteAllText(MyEmailSetupForm.EmailMasterListFilename.Text, textBox_SubjectLine.Text & "," & filenameshort & "," & emailuse & "," & EmailName & vbCrLf, True)
                    Catch ex As Exception
                        ' do nothing
                    End Try
                End If ' Master list
...
#Region "Internet Connection Checks"
    ...
    Public Function checkinternetconnection() As String
        ...
        If MyEmailSetupForm.Checkbox_CheckForIntConnectYesNo.CheckState = CheckState.Checked Or InitialConnectionCheck = True Then
            Try
...
#End Region
    ...
    Private Sub ConfigureEmailButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ConfigureEmailButton.Click
        MyEmailSetupForm.Show()
        MyEmailSetupForm.BringToFront()
        Me.CenterToScreen()
    End Sub
    ...
    Public Sub Fill_ISP_Listbox(ByVal Commonpath As String)
        ...
        While Not SS.EndOfStream
            ...
            'tmp2 = "<" & tmp1(0) & "> " & tmp1(1)
            tmp2 = tmp1(0) & " -- " & tmp1(1)
            MyEmailSetupForm.ComboBox1.Items.Add(tmp2)
        End While
        SS.Close()
    End Sub
    ...
    Public Function MailHood(ByVal emailuse As String, ByVal filenames As String) As MAILERRORHOOD
        ...
        Try
            ...
            If MyEmailSetupForm.textBox_Username.Text = "" Or MyEmailSetupForm.textBox_Password.Text = "" Then
            ...
            Else
                With SmtpServer
                    .Credentials = New Net.NetworkCredential(MyEmailSetupForm.textBox_Username.Text, MyEmailSetupForm.textBox_Password.Text)
                    .Port = CType(MyEmailSetupForm.PortBox.Text, Integer)
                    .Host = MyEmailSetupForm.textBox_MailServer.Text
                    If MyEmailSetupForm.SSLcheckBox.Checked Then
                        .EnableSsl = True
                    Else
                        .EnableSsl = False
                    End If
                ...
                Try
                    With mail
                        .From = New MailAddress(MyEmailSetupForm.CompEmailTextbox.Text, MyEmailSetupForm.CompNameTextbox.Text, System.Text.Encoding.UTF8)
                        ...
                        .ReplyTo = New MailAddress(MyEmailSetupForm.CompEmailTextbox.Text)
    ...
    Public Function TestSMPT() As Boolean
        ...
        client = New System.Net.Sockets.TcpClient(MyEmailSetupForm.textBox_MailServer.Text, CInt(MyEmailSetupForm.PortBox.Text))
    ...
    Public Function MailHoodTest() As MAILERRORHOOD
        ...
        ''SMTPUserInfo = New System.Net.NetworkCredential(ConfigurationManager.AppSettings(MyEmailSetupForm.textBox_Username.Text), ConfigurationManager.AppSettings(MyEmailSetupForm.textBox_Password.Text))
        With SmtpServer
    ...
    Public Function EmailPrompt(ByVal ImageAddress As String) As String
        ' TODO Need to have a setting that will append the filename with the string and save the result in
        '' a 'EmailLater' folder. In order to do this, the SEND button would need to check both folders.
        ...
        If ContinueOrCancel = "Continue" Then
            ...
            emailnamesstrings = MyEmailPrompt.EmailNameText1.Text & "!" & _
MyEmailPrompt.EmailNameText2.Text & "!" & _
MyEmailPrompt.EmailNameText3.Text & "!" & _
MyEmailPrompt.EmailNameText4.Text & "!" & _
MyEmailPrompt.EmailNameText5.Text
        ...
        MyEmailPrompt.EmailNameText1.Text = ""
        MyEmailPrompt.EmailNameText2.Text = ""
        MyEmailPrompt.EmailNameText3.Text = ""
        MyEmailPrompt.EmailNameText4.Text = ""
        MyEmailPrompt.EmailNameText5.Text = ""
        ...
        If MyEmailPrompt.SaveForLaterCheckBox.Checked Then
