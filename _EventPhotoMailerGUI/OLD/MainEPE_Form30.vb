...
Public Class Form1
    ...
    Public Sub SendEmailFromDirectory()
        ...
        Else
            ...
            While d4.Peek() > -1
                ...
                'MsgBox(filename)
                SENDEMAIL(EmailRemoveSpaces, filename, EventFolder, filenameshortDirectory, CancelFlagg)
                'Else
    ...
    Public Sub SendParsedEmails()
        ...
        For Each fullstring In listing
            ...
            If temp.Length < 2 Then
                Dim EV As Integer = MsgBox("Error: The filename is not delimited proplerly or,if you are trying to read from an " _
                       & "email/filename directory, the checkbox was not checked. Would you like to continue?", MsgBoxStyle.YesNo)
                If EV = 6 Then  'Yes
                Else
        ...
        For counter = 0 To NumOfEmailees
            ...
            Else
                ...
                SENDEMAIL(emailstring(counter), filenamestring(counter), EventFolder, filenameshortstring(counter), CancelFlagg)
            End If
    ...
    Private Sub SENDEMAIL(ByVal email As String, ByVal filenamestring As String, ByVal EventFolder As String, ByVal filenameshort As String, ByRef GOFLAGG As String)
        ...
        If CancelFlagg <> "Cancel" Then
            ...
            If Code < 0 Then 'Code corresponding to seeSendEmail()
