...
Public Class Form1
    ...
    'Zephyr Photoworks: 2Jx56wyQMvtZEroyXc20uoTGyEf9cqysrIM73iAco992oa4ekA92IsSGfJGuq2NXBM+ruZh/L471O7UXeol3YA==
    ...
    Structure MAILERRORHOOD
        ...
        Dim SMTPOK As Boolean = checkemail
    End Structure
    ...
    Public Sub LetsGO()
        ...
        If CancelFlagg <> "Cancel" Then
            ...
            While ChkEmailStatus = False Or timecheck < maxduration ' Timeout set to 10 seconds.
                mydate2 = Now
    ...
    End Sub
    Public Sub CheckEmailConnectionOnThread()
        ChkEmailStatus = False
        ChkEmailOnThread = New Thread(AddressOf CheckEmailConnection)
    End Sub
    ...
    Public Function CheckEmailConnection() As MAILERRORHOOD
        ...
        If SmtpErrorCode < 0 Then
            ...
            ChkEmailStatus = False 'Will trigger global variable true when finished.
        Else
            MailError.SMTPOK = True
            ChkEmailStatus = True 'Will trigger global variable true when finished.
        End If
        Return MailError
    End Function
