...
Public Class Form1
    ...
    Public Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Fill_ISP_Listbox(CurrentDirectory & "\EventPhotoEmailer\bin") ' import latest company SMTP server list ("\bin\SMTPServerList.csv")
        ...
        ToolTip1.SetToolTip(MyForm2.EmailCombineCheckBox, "By default, images to the same email address " & vbCrLf & _
                            "are combined into one email. Check this box to send the images individually. ")
        ToolTip1.SetToolTip(MyForm2.CheckBox_ConfirmationEmail, "Check this box if you would like an email also" & vbCrLf & _
    ...
    Public Sub ImportDefaults(ByVal DefaultFileToUse As String)
        ...
        MyForm2.CheckBox_ConfirmationEmail.CheckState = BooleanToCheckState(mydata.ConfimEmailBool)
        MyForm2.EmailCombineCheckBox.CheckState = BooleanToCheckState(mydata.CombineEmailsBool)
        Try
            With MyForm2
    ...
    Private Function BooleanToCheckState(ByVal Mystring As String) As CheckState
    ...
    Private Function CheckStateToBoolean(ByVal MyCheckState As CheckState) As String
    ...
    Public Sub SaveAsXML(ByVal sender As Object, ByVal e As EventArgs) Handles Button_SaveAsDefault.Click
        ...
        MyInfoArraylist.Add("CompanyName" & "!" & MyForm2.CompNameTextbox.Text)
        MyInfoArraylist.Add("CompanyEmail" & "!" & MyForm2.CompEmailTextbox.Text)
        ...
        MyInfoArraylist.Add("UseMasterListBool" & "!" & CheckStateToBoolean(MyForm2.UseMasterListCheckbox.CheckState))
        MyInfoArraylist.Add("ConfimEmailBool" & "!" & CheckStateToBoolean(MyForm2.CheckBox_ConfirmationEmail.CheckState))
        MyInfoArraylist.Add("CombineEmailsBool" & "!" & CheckStateToBoolean(MyForm2.EmailCombineCheckBox.CheckState))
        MyInfoArraylist.Add("UseSSLBool" & "!" & CheckStateToBoolean(MyForm2.SSLcheckBox.CheckState))
        MyInfoArraylist.Add("CheckInternetConnectionBool" & "!" & CheckStateToBoolean(MyForm2.Checkbox_CheckForIntConnectYesNo.CheckState))
        MyInfoArraylist.Add("PostEmailPromptBool" & "!" & CheckStateToBoolean(MyForm2.PostEmailPrompt_CheckBox1.CheckState))
        MyInfoArraylist.Add("UseAdLabelBool" & "!" & CheckStateToBoolean(MyForm2.IncludeAdCheckBox.CheckState))
        MyInfoArraylist.Add("Adfile" & "!" & MyForm2.AdLabel2.Text)
...
#Region "MainProgram"
    ...
    Public Sub SendEmail_AND_HandleControlsOnThread(ByVal sender As Object, ByVal e As ProgressChangedEventArgs) Handles BW_LetsGo.ProgressChanged
        ...
        If CancelFlagg <> "Cancel" Then
            ...
            MainStatusBox.Clear()
            If EmailOnlyRadio.Checked Or EmailAndFacebookRadio.Checked Then ' check smtp server
    ...
    Public Sub SendParsedEmails(ByVal sender As Object, ByVal e As EventArgs) Handles BW_EmailerParcer.DoWork
        ...
        For Each fullstring In listing ' This loops parses the files and produces arrays for email() and filename()
            ...
            If PostEmailPromptYesNo = True And Not FacebookOnlyRadio.Checked Then
                ...
                If temp(0) = "EmailLater" Then  ' This needs to be worked on later
                    'do nothing
                Else
...
#End Region
    ...
    Public Sub Combine(ByRef emailarray() As String, ByRef filenamearray() As String, ByRef emailstring() As String, ByRef filenamestring() As String)
        ...
        If MyForm2.EmailCombineCheckBox.Checked Then
    ...
    Public Sub SENDEMAIL(ByVal email As String, ByVal filenamestring As String, ByVal EventFolder As String, ByVal filenameshort As String, ByRef GOFLAGG As String, ByRef SENDEMAILFLAGG As Boolean)
        ...
        If CancelFlagg <> "Cancel" Then
            ...
            If EmailAndFacebookRadio.Checked Or EmailOnlyRadio.Checked Then
                ...
                If Len(MyForm2.CompEmailTextbox.Text) = 0 Then
                ...
                If MyForm2.IncludeAdCheckBox.Checked And Not MyForm2.AdLabel2.Text = "" Then
                ...
                If BuildType = True Then
                    Try
                        SendEmailCode = MailHood(MyForm2.CompEmailTextbox.Text, FileStringToUse)
                    Catch ex As Exception
                ...
                If MyForm2.CheckBox_ConfirmationEmail.Checked Then
                    Try
                        SendEmailCode = MailHood(MyForm2.CompEmailTextbox.Text, FileStringToUse)
                    Catch ex As Exception
                        SendEmailCode = MailHood(MyForm2.CompEmailTextbox.Text, filenamestring)
                    End Try
                End If
...
#Region "Internet Connection Checks"
    ...
    Public Function checkinternetconnection() As String
        ...
        If MyForm2.Checkbox_CheckForIntConnectYesNo.CheckState = CheckState.Checked Or InitialConnectionCheck = True Then
            Try
...
#End Region
    ...
    Public Function ExtractAccessToken(Mystring As String) As String
        Dim MyURI() As String
    ...
    Public Function MailHood(ByVal emailuse As String, ByVal filenames As String) As MAILERRORHOOD
        ...
        Try
            With mail
                .From = New MailAddress(MyForm2.CompEmailTextbox.Text, MyForm2.CompNameTextbox.Text, System.Text.Encoding.UTF8)
                ...
                .ReplyTo = New MailAddress(MyForm2.CompEmailTextbox.Text)
    ...
    Public Function MailHoodTest() As MAILERRORHOOD
        ...
        ''SMTPUserInfo = New System.Net.NetworkCredential(ConfigurationManager.AppSettings(MyForm2.textBox_Username.Text), ConfigurationManager.AppSettings(MyForm2.textBox_Password.Text))
        With SmtpServer
        ...
        While tryagain <= MaxTries And MailError.SMTPOK = False
            ...
            Catch ex As Exception
                If tryagain <= MaxTries Then
                    tryagain += 1
                    Display(MainStatusBox, "Checking SMTP Server: Try: " & tryagain)
                    Display(MainStatusBox, "Error Message: " & ex.ToString)
                    pause(100) 'used to allow info to show
                    MailError.SMTPerrorMessage = "Error with SMTP. Please check your parameters. No emails were sent. \n Error Message: " & ex.ToString
                    'MailHoodTest()
    ...
    Public Function EmailPrompt(ByVal ImageAddress As String) As String
        ...
        '' a 'WaitUntilLater' folder. In order to do this, the SEND button would need to check both folders.
    ...
    Private Sub NotifyEmailSuccess(ByVal MyMessage As String)
    ...
    Private Sub ClearWindowButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ClearWindowButton.Click
        MainStatusBox.Clear()
    End Sub

    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MakeThinButton.Click
        'Activate Make Thin
        MyMakeThinForm.Show()
    End Sub
End Class
