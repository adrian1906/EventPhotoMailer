...
Public Class Form1
    ...
    Public Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If File.Exists("c:\EventPhotoEmailer\MT\QIMConfig.xml") Then
            HotFolder.Text = readXML("c:\EventPhotoEmailer\MT\QIMConfig.xml", "HotFolder")
        Else
            HotFolder.Text = "C:\EventPhotoEmailer\MT\MTHotFolder"
        End If

        WF3.Path = "c:\EventPhotoEmailer\MT\ThreeP"
        WF5.Path = "c:\EventPhotoEmailer\MT\FiveP"
        WF10.Path = "c:\EventPhotoEmailer\MT\TenP"
        WF3.Filter = "*.jpg"
        WF5.Filter = "*.jpg"
        WF10.Filter = "*.jpg"
    End Sub
    ...
    Private Function readXML(ByVal filename As String, ByVal fieldname As String) As String
    ...
    Private Sub SaveButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SaveButton.Click
        SaveAsXML("c:\EventPhotoEmailer\MT\QIMConfig.xml")
    End Sub
End Class
