...
#End Region
    ...
    ''    Inherits Facebook_Graph_Toolkit.CanvasPage
    ''    Private Sub Page_PreInit(ByVal sender As Object, ByVal e As EventArgs)
    ''        Dim RequireLogin As Boolean = True
    ''        Dim ExtendedPermissions As String = "user_photos,publish_stream"
    ''    End Sub
    ''End Class
...
#Region "Facebook Stuff"
    ...
    Public Function GetFacebookAPI(ByVal EMAILFIELD As String, ByVal PASSWORFIELD As String) As GraphApi.Api
        ' Adrian ID:        601201034
        ' Hood and Sons ID: 152049444821811
        ...
        ' Get Access Token
        Dim AdrianID As String = "601201034"
        ...
        For Each curElement As HtmlElement In theElementCollection
            ...
            If controlName = "email" Then
                curElement.SetAttribute("Value", EMAILFIELD)
            ElseIf controlName = "pass" Then
                curElement.SetAttribute("Value", PASSWORFIELD)
            End If
        Next
        ...
        ' Get list of Friends
        'Dim GRAPHAPI As String = "https://graph.facebook.com/" & "601201034/" 'Adrian Hood Account
        'Dim GRAPHAPI As String = "https://graph.facebook.com/" & myAPI.UserID 'Adrian Hood Account
